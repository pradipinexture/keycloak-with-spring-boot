...
<@layout.registrationLayout displayInfo=social.displayInfo; section>
    ...
    <#elseif section = "header">
        ...
        <link href="${url.resourcesPath}/img/spring-boot-logo.png" rel="icon"/>
        <script>
    ...
    <#elseif section = "form">
        <div>
            <img class="logo" src="${url.resourcesPath}/img/spring-boot.png" alt="Pradip">
        </div>
        <div class="box-container">
            <div>
                <p class="application-name">Custom Login Page</p>
            </div>
        <#if realm.password>
            <div>
